...
$cons_sql  = sprintf("UPDATE general SET institucion=%s,descripcion=%s,foto=%s WHERE id=1", comillas($finstitucion), comillas($fdescripcion), comillas($factivar));
...
$cons_sql2  = sprintf("INSERT INTO control(fecha,hora,ip,accion) VALUES(%s,%s,%s,%s)", comillas($ffecha), comillas($fhora), comillas($fip), comillas($faccion));
